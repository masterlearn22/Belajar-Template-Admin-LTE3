                        ...
                        <div class="col-md-3">
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle"
                                            src="../../dist/img/suryapp.jpg" alt="User profile picture">
                                    </div>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">Aku sedang belajar layouting guys, sabar yaa untuk tampilan
                                        tampilan terbarunyaaa</p>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            <!-- /.card -->
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    <img class="img-circle img-bordered-sm"
                                                        src="../../dist/img/luffypp.jpeg" alt="user image">
                                                    <span class="username">
                                                ...
                                                <!-- /.user-block -->
                                                <p>
                                                    Hai Nakama, selamat datang di layouting bersamaku, kita taklukan
                                                    Laravel hingga aku jadi Raja Programmer
                                                </p>
                                            ...
                                            <div class="post">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid" src="../../dist/img/ace.jpg"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <img class="img-fluid mb-3"
                                                                    src="../../dist/img/sunny.jpg" alt="Photo">
                                                                <img class="img-fluid"
                                                                    src="../../dist/img/corazon.jpg" alt="Photo">
                                                            </div>
                                                            <!-- /.col -->
                                                            <div class="col-sm-6">
                                                                <img class="img-fluid mb-3"
                                                                    src="../../dist/img/law.jpg" alt="Photo">
                                                                <img class="img-fluid mb-3"
                                                                    src="../../dist/img/fightOP.jpg" alt="Photo">
                                                            </div>
                                                            <!-- /.col -->
                                                        </div>
                                                        <!-- /.row -->
